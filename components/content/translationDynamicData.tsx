...
const TranslationDynamicData = observer(({nameRu, nameEn, align = 'center', color = 'rgba(255,255,255,.48)', weight = 400, size = '0.98rem', line = '20px'}:TranslationDynamicDataProps) => {
