...
const Footer = () => {
  ...
  const firstColumnContent = [
    ...
    {
      link: "https://www.ivi.tv/pages/beta/",
      content: t("Программа бета-тестирования"),
    },
    {
      link: "https://www.ivi.tv/info/partners",
      content: t("Информация для партнёров"),
    },
    {
      link: "https://corp.ivi.ru/advertisers/",
      content: t("Размещение рекламы"),
    },
    {
      link: "https://www.ivi.tv/info/agreement",
      content: t("Пользовательское соглашение"),
    },
    {
      link: "https://www.ivi.tv/info/confidential",
      content: t("Политика конфиденциальности"),
    },
    {
      link: "https://www.ivi.tv/info/goryachaya-liniya-komplaens",
      content: t("Комплаенс"),
    },
  ];
  ...
  return (
    <Container maxWidth={false} sx={{ width: "77.5rem", mb: "1rem" }}>
      <Box
        component="footer"
        sx={{ flex: 1, "@media (max-width: 1200px)": { display: "none" } }}
      >
        <Hr />
        <Grid
          container
          ...
          <Grid item>
            ...
            >
              ...
              <Box width={252} marginTop={"20px"}>
                <MyText
                  text={t("Смотрите фильмы, сериалы и мультфильмы без рекламы")}
                  align={"center"}
                />
              </Box>
              <Box sx={{m:'2rem auto'}}>
