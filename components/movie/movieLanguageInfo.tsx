...
const MovieLanguageInfo = ({justifyContent}:MovieLanguageInfoProps) => {
    return (
      <Stack direction='row' spacing={1}  alignItems="center" sx={{mt:'1rem', justifyContent}}>
   
        <Box sx={{display:'flex',alignItems:'center',justifyContent:'center' ,width:'68px', height:'24px',padding:'0 0.5rem',backgroundColor: 'rgba(255,255,255,.16)', borderRadius:'8px' }}>
